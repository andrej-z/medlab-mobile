...
if (preference== null)
    ...
    public static class GeneralPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            Preference removeCredentials = (Preference) findPreference("resetCreds");

            // setup buttons
            final Context context = getActivity();
            removeCredentials.setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
                @Override
                public boolean onPreferenceChange(Preference preference, Object o) {
                    AppContext.Get().dataService.resetCredentials();
                    new AlertDialog.Builder(context)
                            .setTitle("Done")
                            .setMessage("You should restart application to register. Restart now?")
    ...
    public static class DataSyncPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            Preference clearAllData = (Preference) findPreference("resetBD");
            ...
            clearAllData.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
                ...
                public boolean onPreferenceClick(Preference preference) {
                    context.deleteDatabase("cdms");
                    new AlertDialog.Builder(context)
                            .setTitle("Done")
                            .setMessage("You should restart application to see changes. Restart now?")
                            .setIcon(android.R.drawable.ic_dialog_alert)
                            .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
